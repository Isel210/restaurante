...
import Clases.ReservasDao;
import Clases.Tarifas;
import Clases.TarifasDao;
import Clases.Salas;
import Clases.SalasDao;
...
public final class Sistema extends javax.swing.JFrame {
    ...
    Tarifas pla = new Tarifas();
    TarifasDao plaDao = new TarifasDao();

    Reservas ped = new Reservas();
    ReservasDao pedDao = new ReservasDao();
    DetalleReserva detPedido = new DetalleReserva();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 10, 1060, 130));
        ...
        LabelVendedor.setBackground(new java.awt.Color(97, 10, 17));
        ...
        PanelBox.setLayout(new java.awt.GridLayout(0, 5));
        jScrollPane9.setViewportView(PanelBox);
        ...
        jPanel24.setBorder(javax.swing.BorderFactory.createTitledBorder("Tarifas"));
        ...
        tableMenu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Tarifa", "Cant", "Precio", "SubTotal", "Comentario"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jLabel20.setText("Nueva Reserva");
        ...
        jPanel24.getAccessibleContext().setAccessibleName("Tarifas");
        ...
        totalFinalizar.setBackground(new java.awt.Color(255, 255, 255));
        totalFinalizar.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        totalFinalizar.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tableFinalizar.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Box", "Cant", "Precio", "SubTotal", "Comentario"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, true
        ...
        TablePedidos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Sala", "Atendido", "N° Box", "Fecha", "Total", "Estado"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jLabel16.setText("Historial Reservas");
        ...
        jTabbedPane1.addTab("Tarifa", jPanel2);
    ...
    private void btnGenerarPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarPedidoActionPerformed
        if (tableMenu.getRowCount() > 0) {
            ...
            JOptionPane.showMessageDialog(null, "NO HAY PRODUCTO EN RESERVA");
        }
    ...
    private void btnGuardarPlatoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarPlatoActionPerformed
        ...
        if (!"".equals(txtNombrePlato.getText()) || !"".equals(txtPrecioPlato.getText())) {
            ...
            if (plaDao.Registrar(pla)) {
                JOptionPane.showMessageDialog(null, "Tarifa Registrada");
                LimpiarTable();
                ListarPlatos(TablePlatos);
                LimpiarPlatos();
            }
    ...
    private void ListarPedidos() {
        ...
        List<Reservas> Listar = pedDao.listarPedidos();
    ...
    private void panelMesas(int id_sala, int cant) {
        for (int i = 1; i <= cant; i++) {
            int num_mesa = i;
            //verificar estado
            JButton boton = new JButton("BOX N°: " + i, new ImageIcon(getClass().getResource("/Img/mesa.png")));
            boton.setHorizontalTextPosition(JButton.CENTER);
            boton.setVerticalTextPosition(JButton.BOTTOM);
    ...
    private void ListarPlatos(JTable tabla) {
        List<Tarifas> Listar = plaDao.Listar(txtBuscarPlato.getText(), fechaFormato);
    ...
    public void verPedidoDetalle(int id_pedido) {
        List<DetalleReserva> Listar = pedDao.verPedidoDetalle(id_pedido);
